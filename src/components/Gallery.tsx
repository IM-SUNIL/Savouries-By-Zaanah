        ...
        <div className="text-center mt-16">
          <div className="bg-orange-50 rounded-lg p-8 max-w-2xl mx-auto">
            ...
            <button 
              ...
              className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Visit Us Today
            </button>
          </div>
